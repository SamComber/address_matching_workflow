...
house_dict = {'name':'house',
                     'type':'freq',
               'char_range':'alpha',
               # 'freq_file':'freqs/house_fodor_freq.csv',               
               'freq_file':'freqs/house_zagat_freq.csv',               
              'select_prob':0.15,
                 'ins_prob':0.10,
                 'del_prob':0.20,
                 'sub_prob':0.50,
...
streetnumber_dict = {'name':'house_number',
                     'type':'freq',
               'char_range':'digit',
...
road_dict = {'name':'road',
                     'type':'freq',
               'char_range':'alpha',
               # 'freq_file':'freqs/road_fodor_freq.csv',
               'freq_file':'freqs/road_zagat_freq.csv',
              'select_prob':0.10,
                 'ins_prob':0.00,
                 'del_prob':0.00,
                 'sub_prob':0.30,
...
suburb_dict = {'name':'suburb',
                     'type':'freq',
               'char_range':'alpha',
               # 'freq_file':'freqs/suburb_fodor_freq.csv',
               'freq_file':'freqs/suburb_zagat_freq.csv',
              'select_prob':0.05,
                 'ins_prob':0.00,
                 'del_prob':0.00,
                 'sub_prob':0.05,
...
city_dict = {'name':'city',
                     'type':'freq',
               'char_range':'alpha',
               # 'freq_file':'freqs/city_fodor_freq.csv',
               'freq_file':'freqs/city_zagat_freq.csv',
              'select_prob':0.15,
                 'ins_prob':0.00,
                 'del_prob':0.00,
                 'sub_prob':0.50,
...
zip_dict = {'name':'postcode',
                     'type':'freq',
               'char_range':'digit',
               # 'freq_file':'freqs/postcode_fodor_freq.csv',
               'freq_file':'freqs/postcode_zagat_freq.csv',
              'select_prob':0.35,
                 'ins_prob':0.00,
                 'del_prob':0.00,
                 'sub_prob':0.00,
...
field_list = [house_dict, streetnumber_dict, road_dict,
              suburb_dict, city_dict, zip_dict]
